...
\begin{itemize}
  ...
  \vspace{0.5em}
    ...
    \begin{adjustwidth}{0.3em}{0pt}
      ...
      \begin{tabular}{@{}r l@{}}
      \textbf{Input:} & page $i$ image and dialogue,\\
...
\caption{
Statistics of Manga109Script. "Distinct character types" is the count of unique characters identified per page, while "unique speaker types" is the number of distinct speaker IDs per page.
}
