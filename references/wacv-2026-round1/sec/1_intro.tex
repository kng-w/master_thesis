...
Storytelling takes many forms, from text-focused novels to visually-driven animation. Among these, manga has developed a unique expressive form that divides a flat surface into panels containing characters and dialogue. In typical manga production, the process of translating a narrative into a visual layout occurs in a preliminary draft called a "name." The layout therefore embodies critical directorial decisions. Its composition, particularly the positioning of panels, characters, and speech bubbles, is a deliberate choice designed to structure the visual narrative and ensure the story is communicated clearly and with intended emotional weight~\cite{fukaya_mangalayout}.
...
To support VLLMs limitations, we applied Visual Prompting~\cite{shtedritski_what_2023} with the Manga109 dataset annotations and employed a rule-based algorithm designed for panel reading order~\cite{sachdeva_manga_2024}, to generate high-quality narrative script data.
